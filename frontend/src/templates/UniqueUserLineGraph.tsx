// components/UniqueUserLineGraph.tsx
...
const UniqueUserLineGraph: React.FC = () => {
  const  darkMode  = true;
  ...
  const options: Highcharts.Options = {
    ...
    title: {
      text: 'Unique Users Per Day for a Month',
      align: 'left',
      style: {
        color: darkMode ? '#fff' : '#000',
      },
  ...
  return (
    <div className="higcharts-ctr mb-4 rounded-lg bg-slate-200 text-black dark:bg-default-primary400 dark:text-white">
      <HighchartsReact highcharts={Highcharts} options={options} />
    </div>
  );
};

export default UniqueUserLineGraph;
